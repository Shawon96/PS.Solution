  ...
  if (navigator.geolocation)
  {
    ...
    (
      function (position)
      {
        ...
        marker = new google.maps.Marker({ position: pos, map: map, title: 'You are Hare..!', draggable: true });
...
function markerDragged()
{
  ...
  document.getElementById("lt").value = mPos.lat;
  document.getElementById("ln").value = mPos.lng;
}
